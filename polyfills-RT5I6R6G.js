    ...
    class k {
        constructor(t, s, o) {
            (this._taskCounts = { microTask: 0, macroTask: 0, eventTask: 0 }),
                ...
                (this._forkCurrZone =
                    o && (o.onFork ? this.zone : s._forkCurrZone)),
                (this._interceptZS = o && (o.onIntercept ? o : s._interceptZS)),
                (this._interceptDlgt =
                    o && (o.onIntercept ? s : s._interceptDlgt)),
                ...
                (this._handleErrorZS =
                    o && (o.onHandleError ? o : s._handleErrorZS)),
                (this._handleErrorDlgt =
                    o && (o.onHandleError ? s : s._handleErrorDlgt)),
                (this._handleErrorCurrZone =
                    o &&
                    (o.onHandleError ? this.zone : s._handleErrorCurrZone)),
                ...
                (this._scheduleTaskCurrZone =
                    o &&
                    (o.onScheduleTask ? this.zone : s._scheduleTaskCurrZone)),
                (this._invokeTaskZS =
                    o && (o.onInvokeTask ? o : s._invokeTaskZS)),
                (this._invokeTaskDlgt =
                    o && (o.onInvokeTask ? s : s._invokeTaskDlgt)),
                (this._invokeTaskCurrZone =
                    o && (o.onInvokeTask ? this.zone : s._invokeTaskCurrZone)),
                (this._cancelTaskZS =
                    o && (o.onCancelTask ? o : s._cancelTaskZS)),
                (this._cancelTaskDlgt =
                    o && (o.onCancelTask ? s : s._cancelTaskDlgt)),
    ...
    class t {
        ...
        then(u, i) {
            ...
            let g = new h(se),
                w = n.current;
            return (
                this[q] == M ? this[R].push(w, g, u, i) : ee(this, w, g, u, i),
                g
            );
        }
        catch(u) {
            ...
            let g = n.current;
            return (
                this[q] == M ? this[R].push(g, h, u, u) : ee(this, g, h, u, u),
                h
            );
        }
    }
                    ...
                    try {
                        if (O.hasOwnProperty(m)) {
                            ...
                            Z && Z.value
                                ...
                                : O[m] &&
                                  (O[m] = e.wrapWithCurrentZone(O[m], I));
